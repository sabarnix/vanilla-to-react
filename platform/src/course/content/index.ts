 ...
 *
 * Exports the authored Days in course order. Day 1-2 (T8), Day 3-4 (T9), and
 * Day 5-6 (T10) are appended here; a future day-content ticket (T11: Day 7)
 * appends its Day objects to this same array, in order, following this
 * exact shape:
 *
 *   export const days: Day[] = [day1, day2, day3, day4, day5, day6, ...];
 *
